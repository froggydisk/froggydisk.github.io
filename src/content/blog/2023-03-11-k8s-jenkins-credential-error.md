---
title: "Jenkins에서 Credential 등록 불가 에러"
...
<p align="center"><img src="/img/18th.png" alt="Jenkins Credentials 등록 화면에서 발생한 에러 메시지" /></p>
...
`kubectl get pv -A`로 pv 관련 reclaim policy 설정이 <strong>`Retain`</strong>으로 되어 있나 확인한다.
